    ...
    return (
        <div className="flex flex-wrap">
            {events.map((event, index) => {
                ...
                const cardClasses = `w-36 h-36 border border-gray-200 p-2 m-2 flex flex-col justify-center items-center rounded shadow-sm text-center overflow-hidden 
                ${isLeagueMatch ? "bg-blue-500" : "bg-white"}`;
